	...
	private void emmenagerDruide(String nomVisiteur) {
		...
		while(effetPotionMax<effetPotionMin) {
			...
			effetPotionMin = Clavier.entrerEntier("Quelle est la force de potion "
					+ "la plus faible que vous produisez ?");
			effetPotionMax = Clavier.entrerEntier("Quelle est la force de potion la plus forte "
					+ "que vous produisez ?");
			if(effetPotionMax<effetPotionMin) {
				System.out.println("Attention Druide, vous vous êtes trompé entre le minimum"
						+ " et le maximum.");}
